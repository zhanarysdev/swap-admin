...
export default function Login() {
  ...
  const login = async () => {
    const res = await post({
      url: "business/v1/login",
      data: { phone_number: phone, code: password },
      custom: true,
    });
  ...
  if (step === 1) {
    return (
      <div>
        <div className="text-white text-[24px]  font-[800]">
        ...
        <Link
          ...
          className="text-white text-[14px] font-[500] underline"
        >
